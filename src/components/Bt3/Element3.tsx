        ...
        <ul className="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
          ...
          <li className="has-children">
            ...
            <ul className="dropdown">
              <li className="active"><a href="elements.html">Elements</a></li>
        ...
        <div className="col-lg-10">
          ...
          <div className="row">
            <div className="col-lg-3 mb-4">
              <div className="team">
                <img src="images/person_1.jpg" alt="Image" className="img-fluid mb-4"/>
                <div className="px-3">
            ...
            <div className="col-lg-3 mb-4">
              <div className="team">
                <img src="images/person_2.jpg" alt="Image" className="img-fluid mb-4"/>
                <div className="px-3">
            ...
            <div className="col-lg-3 mb-4">
              <div className="team">
                <img src="images/person_4.jpg" alt="Image" className="img-fluid mb-4"/>
                <div className="px-3">
            ...
            <div className="col-lg-3 mb-4">
              <div className="team">
                <img src="images/person_3.jpg" alt="Image" className="img-fluid mb-4"/>
                <div className="px-3">
